...
class TestEditProjectLocal:
    ...
    async def test_edits_section(self, tmp_path):
        ...
        result = await handle(
            {"project_path": str(project_dir), "section": "Goals", "content": "New goals."}
        )
    ...
    async def test_missing_project_md(self, tmp_path):
        ...
        result = await handle(
            {"project_path": str(project_dir), "section": "Goals", "content": "x"}
        )
    ...
    async def test_section_not_found(self, tmp_path):
        ...
        result = await handle(
            {"project_path": str(project_dir), "section": "Nonexistent", "content": "x"}
        )
    ...
    async def test_blocked_by_allowlist(self, monkeypatch):
        ...
        result = await handle(
            {"project_path": "unapproved-org/some-repo", "section": "Goals", "content": "x"}
        )
...
class TestEditProjectRemote:
    ...
    async def test_remote_edit(self, monkeypatch):
        ...
        with (
            ...
            result = await handle(
                {"project_path": "owner/repo", "section": "Goals", "content": "Remote goals."}
            )
