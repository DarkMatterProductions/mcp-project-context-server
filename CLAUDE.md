...
- At the start of every session, call the `mcp__project_context__load_project_context` tool before doing anything else.
...
- ALWAYS ask clarifying questions before giving detailed answers or offering solutions.
- ALWAYS ask clarifying questions before offering solutions.
